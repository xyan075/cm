...
MODULE EQUATIONS_SET_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_RIGID_BODY_CLASS=10
 ...
 !Bioelectrics class
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FINITE_ELASTICITY_RIGID_BODY_TYPE=6
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_PELVIC_FLOOR_SUBTYPE=29
