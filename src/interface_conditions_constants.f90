...
MODULE INTERFACE_CONDITIONS_CONSTANTS
  ...
  !> \addtogroup INTERFACE_CONDITIONS_CONSTANTS_Connectivity INTERFACE_CONDITIONS_CONSTANTS::Connectivity
  !> \brief Interface condition connectivity.
  !> \see INTERFACE_CONDITIONS_CONSTANTS
  !>@{
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_MESH_CONNECTIVITY=1 !<Use a mesh at the interface region and integral evaluated at nodal positions. \see INTERFACE_CONDITIONS_CONSTANTS_Connectivity,INTERFACE_CONDITIONS_CONSTANTS 
  INTEGER(INTG), PARAMETER :: INTERFACE_CONDITION_POINTS_CONNECTIVITY=2 !<Use data points at the interface region and approximate integrals at positions of data points. \see INTERFACE_CONDITIONS_CONSTANTS_Connectivity,INTERFACE_CONDITIONS_CONSTANTS 
  !>@}
