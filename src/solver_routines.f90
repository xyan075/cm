...
#include "include/petscversion.h"
  ...
  PUBLIC SOLVER_GEOMETRIC_TRANSFORMATION_FIELD_SET,SOLVER_TRANSFORMATION_TRANSLATION_INCREMENT_SET
    ...
    IF(ASSOCIATED(SOLVER)) THEN
      ...
      ELSE
        ...
        CASE(SOLVER_GEOMETRIC_TRANSFORMATION_TYPE)
          CALL SOLVER_GEOMETRIC_TRANSFORMATION_CREATE_FINISH(SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER,ERR,ERROR,*999)
        CASE DEFAULT
...
999 CALL ERRORS("SOLVER_EQUATIONS_TIME_DEPENDENCE_TYPE_SET",ERR,ERROR)
  ...
  RECURSIVE SUBROUTINE SOLVER_FINALISE(SOLVER,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(SOLVER)) THEN
      ...
      CALL SOLVER_GEOMETRIC_TRANSFORMATION_FINALISE(SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER,ERR,ERROR,*999)
...
999 CALL ERRORS("SOLVER_NEWTON_CELLML_EVALUATOR_CREATE",ERR,ERROR)
  ...
  SUBROUTINE SOLVER_GEOMETRIC_TRANSFORMATION_FINALISE(GEOMETRIC_TRANSFORMATION_SOLVER,ERR,ERROR,*)

    !Argument variables
    TYPE(GEOMETRIC_TRANSFORMATION_SOLVER_TYPE), POINTER :: GEOMETRIC_TRANSFORMATION_SOLVER !<A pointer the linear solver to finalise
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables

    CALL ENTERS("SOLVER_GEOMETRIC_TRANSFORMATION_FINALISE",ERR,ERROR,*999)

    IF(ASSOCIATED(GEOMETRIC_TRANSFORMATION_SOLVER)) THEN   
      NULLIFY(GEOMETRIC_TRANSFORMATION_SOLVER%SOLVER)
      NULLIFY(GEOMETRIC_TRANSFORMATION_SOLVER%FIELD)
      DEALLOCATE(GEOMETRIC_TRANSFORMATION_SOLVER%TRANSLATION)
      DEALLOCATE(GEOMETRIC_TRANSFORMATION_SOLVER%ROTATION)
      DEALLOCATE(GEOMETRIC_TRANSFORMATION_SOLVER)
    ENDIF
        
    CALL EXITS("SOLVER_GEOMETRIC_TRANSFORMATION_FINALISE")
    RETURN
999 CALL ERRORS("SOLVER_GEOMETRIC_TRANSFORMATION_FINALISE",ERR,ERROR)
    CALL EXITS("SOLVER_GEOMETRIC_TRANSFORMATION_FINALISE")
    RETURN 1
   
  END SUBROUTINE SOLVER_GEOMETRIC_TRANSFORMATION_FINALISE
  ...
  SUBROUTINE SOLVER_GEOMETRIC_TRANSFORMATION_INITIALISE(SOLVER,ERR,ERROR,*)
    ...
    CALL ENTERS("SOLVER_GEOMETRIC_TRANSFORMATION_INITIALISE",ERR,ERROR,*998)
    ...
    IF(ASSOCIATED(SOLVER)) THEN
      ...
      ELSE
        ...
        ALLOCATE(SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER,STAT=ERR)
        IF(ERR/=0) CALL FLAG_ERROR("Could not allocate solver geometric transformation solver.",ERR,ERROR,*999)
        SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER%SOLVER=>SOLVER
        NULLIFY(SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER%FIELD)
      ENDIF
    ELSE
      CALL FLAG_ERROR("Solver is not associated.",ERR,ERROR,*998)
    ENDIF
        
    CALL EXITS("SOLVER_GEOMETRIC_TRANSFORMATION_INITIALISE")
    RETURN
999 CALL SOLVER_GEOMETRIC_TRANSFORMATION_FINALISE(SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER,DUMMY_ERR,DUMMY_ERROR,*998)
998 CALL ERRORS("SOLVER_GEOMETRIC_TRANSFORMATION_INITIALISE",ERR,ERROR)
    CALL EXITS("SOLVER_GEOMETRIC_TRANSFORMATION_INITIALISE")
    RETURN 1
   
  END SUBROUTINE SOLVER_GEOMETRIC_TRANSFORMATION_INITIALISE
  
  !
  !================================================================================================================================
  !

  !>Finishes the process of creating a geometric transformation solver 
  SUBROUTINE SOLVER_GEOMETRIC_TRANSFORMATION_CREATE_FINISH(GEOMETRIC_TRANSFORMATION_SOLVER,ERR,ERROR,*)

    !Argument variables
    TYPE(GEOMETRIC_TRANSFORMATION_SOLVER_TYPE), POINTER :: GEOMETRIC_TRANSFORMATION_SOLVER !<A pointer to the geometric transformation solver to finish the creation of.
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
    TYPE(VARYING_STRING) :: LOCAL_ERROR

    CALL ENTERS("SOLVER_GEOMETRIC_TRANSFORMATION_CREATE_FINISH",ERR,ERROR,*999)

    IF(ASSOCIATED(GEOMETRIC_TRANSFORMATION_SOLVER)) THEN
      GEOMETRIC_TRANSFORMATION_SOLVER%SOLVER%SOLVER_FINISHED=.TRUE.
    ELSE
      CALL FLAG_ERROR("Geometric transformation solver is not associated.",ERR,ERROR,*999)
    ENDIF
        
    CALL EXITS("SOLVER_GEOMETRIC_TRANSFORMATION_CREATE_FINISH")
    RETURN
999 CALL ERRORS("SOLVER_GEOMETRIC_TRANSFORMATION_CREATE_FINISH",ERR,ERROR)
    CALL EXITS("SOLVER_GEOMETRIC_TRANSFORMATION_CREATE_FINISH")
    RETURN 1
   
  END SUBROUTINE SOLVER_GEOMETRIC_TRANSFORMATION_CREATE_FINISH
  
  !
  !================================================================================================================================
  !

  !> Set field to translate 
  SUBROUTINE SOLVER_GEOMETRIC_TRANSFORMATION_FIELD_SET(SOLVER,FIELD,VARIABLE_TYPE,ERR,ERROR,*)

    !Argument variables
    TYPE(SOLVER_TYPE), POINTER :: SOLVER
    TYPE(FIELD_TYPE), POINTER :: FIELD !<A pointer to the field to translate
    INTEGER(INTG), INTENT(IN) :: VARIABLE_TYPE
    INTEGER(INTG), INTENT(OUT) :: ERR !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
    TYPE(GEOMETRIC_TRANSFORMATION_SOLVER_TYPE), POINTER :: GEOMETRIC_TRANSFORMATION_SOLVER
    TYPE(FIELD_VARIABLE_TYPE), POINTER :: FIELD_VARIABLE
    INTEGER(INTG) :: NUMBER_OF_ITERATIONS
    TYPE(VARYING_STRING) :: LOCAL_ERROR

    CALL ENTERS("SOLVER_GEOMETRIC_TRANSFORMATION_FIELD_SET",ERR,ERROR,*999)
    
    IF(ASSOCIATED(SOLVER)) THEN
      NUMBER_OF_ITERATIONS=SOLVER%SOLVERS%CONTROL_LOOP%LOAD_INCREMENT_LOOP%MAXIMUM_NUMBER_OF_ITERATIONS
      IF(SOLVER%SOLVE_TYPE==SOLVER_GEOMETRIC_TRANSFORMATION_TYPE) THEN
        NULLIFY(GEOMETRIC_TRANSFORMATION_SOLVER)
        GEOMETRIC_TRANSFORMATION_SOLVER=>SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER
        IF(ASSOCIATED(GEOMETRIC_TRANSFORMATION_SOLVER)) THEN
          IF(ASSOCIATED(FIELD)) THEN
            IF(FIELD%TYPE==FIELD_GEOMETRIC_TYPE) THEN
              SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER%FIELD=>FIELD
              FIELD_VARIABLE=>FIELD%VARIABLE_TYPE_MAP(VARIABLE_TYPE)%PTR
              ALLOCATE(SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER%TRANSLATION(FIELD_VARIABLE%NUMBER_OF_COMPONENTS, &
                & NUMBER_OF_ITERATIONS),STAT=ERR)
            ELSE IF(FIELD%TYPE==FIELD_GEOMETRIC_GENERAL_TYPE) THEN
              SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER%FIELD=>FIELD
              FIELD_VARIABLE=>FIELD%VARIABLE_TYPE_MAP(VARIABLE_TYPE)%PTR
              SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER%VARIABLE_TYPE=VARIABLE_TYPE
              ALLOCATE(SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER%TRANSLATION(FIELD_VARIABLE%NUMBER_OF_COMPONENTS-1, &
                & NUMBER_OF_ITERATIONS),STAT=ERR)
            ELSE
              CALL FLAG_ERROR("Field is not geometric or geometric general type.",ERR,ERROR,*999)
            ENDIF
          ELSE
    ...
    CALL EXITS("SOLVER_GEOMETRIC_TRANSFORMATION_FIELD_SET")
    RETURN
999 CALL ERRORS("SOLVER_GEOMETRIC_TRANSFORMATION_FIELD_SET",ERR,ERROR)
    CALL EXITS("SOLVER_GEOMETRIC_TRANSFORMATION_FIELD_SET")
    RETURN 1
  END SUBROUTINE SOLVER_GEOMETRIC_TRANSFORMATION_FIELD_SET
  
  !
  !================================================================================================================================
  !

  !> Set translation a field at a specific load increment
  SUBROUTINE SOLVER_TRANSFORMATION_TRANSLATION_INCREMENT_SET(SOLVER,FIELD,VARIABLE_TYPE,ITERATION_NUMBER,TRANSLATION, &
      & ERR,ERROR,*)
    ...
    CALL ENTERS("SOLVER_TRANSFORMATION_TRANSLATION_INCREMENT_SET",ERR,ERROR,*999)
    ...
    IF(ASSOCIATED(SOLVER)) THEN
      ...
      IF(SOLVER%SOLVE_TYPE==SOLVER_GEOMETRIC_TRANSFORMATION_TYPE) THEN
        ...
        GEOMETRIC_TRANSFORMATION_SOLVER=>SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER
        IF(ASSOCIATED(GEOMETRIC_TRANSFORMATION_SOLVER)) THEN
          IF(ASSOCIATED(FIELD,SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER%FIELD)) THEN
            IF(SIZE(GEOMETRIC_TRANSFORMATION_SOLVER%TRANSLATION,1)==SIZE(TRANSLATION,1)) THEN
              IF(ITERATION_NUMBER<=NUMBER_OF_ITERATIONS) THEN
                GEOMETRIC_TRANSFORMATION_SOLVER%TRANSLATION(:,ITERATION_NUMBER)=TRANSLATION
              ELSE
                CALL FLAG_ERROR("Iteration number out of range.",ERR,ERROR,*999)
              ENDIF
            ELSE
              CALL FLAG_ERROR("Size of translation vector does not match that of field geometric variable.",ERR,ERROR,*999)
            ENDIF
          ELSE
            CALL FLAG_ERROR("Field to set translation for does not match solver field.",ERR,ERROR,*999)
          ENDIF
        ELSE
          CALL FLAG_ERROR("Geometric transformation solver is not associated.",ERR,ERROR,*999)
        ENDIF
    ...
    CALL EXITS("SOLVER_TRANSFORMATION_TRANSLATION_INCREMENT_SET")
    RETURN
999 CALL ERRORS("SOLVER_TRANSFORMATION_TRANSLATION_INCREMENT_SET",ERR,ERROR)
    CALL EXITS("SOLVER_TRANSFORMATION_TRANSLATION_INCREMENT_SET")
    RETURN 1
  END SUBROUTINE SOLVER_TRANSFORMATION_TRANSLATION_INCREMENT_SET
...
998 CALL ERRORS("SOLVER_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE SOLVER_INITIALISE_PTR(SOLVER,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(SOLVER)) THEN
      ...
      NULLIFY(SOLVER%GEOMETRIC_TRANSFORMATION_SOLVER)
      ...
      ELSE
        ...
        ELSE
          IF(SOLVE_TYPE/=SOLVER%SOLVE_TYPE) THEN
            ...
            CASE(SOLVER_GEOMETRIC_TRANSFORMATION_TYPE)
              CALL SOLVER_GEOMETRIC_TRANSFORMATION_INITIALISE(SOLVER,ERR,ERROR,*999)
            CASE DEFAULT
