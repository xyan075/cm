...
MODULE FINITE_ELASTICITY_ROUTINES
  ...
  PUBLIC FINITE_ELASTICITY_ANALYTIC_CALCULATE, &
    ...
    & FINITE_ELASTICITY_PROBLEM_SUBTYPE_SET,FINITE_ELASTICITY_CONTACT_PROBLEM_SUBTYPE_SET, & 
    & FINITE_ELASTICITY_PROBLEM_SETUP,FINITE_ELASTICITY_CONTACT_PROBLEM_SETUP, &
...
999 CALL ERRORS("FINITE_ELASTICITY_PROBLEM_SETUP",ERR,ERROR)
  ...
  !>Sets up the finite elasticity problem.
  SUBROUTINE FINITE_ELASTICITY_CONTACT_PROBLEM_SETUP(PROBLEM,PROBLEM_SETUP,ERR,ERROR,*)
    ...
    !Local Variables
    TYPE(CONTROL_LOOP_TYPE), POINTER :: CONTROL_LOOP,CONTROL_LOOP_ROOT
    TYPE(SOLVER_TYPE), POINTER :: NONLINEAR_SOLVER,TRANSFORMATION_SOLVER,PROJECTION_SOLVER
    TYPE(SOLVER_TYPE), POINTER :: CELLML_SOLVER
    TYPE(SOLVER_EQUATIONS_TYPE), POINTER :: SOLVER_EQUATIONS
    TYPE(CELLML_EQUATIONS_TYPE), POINTER :: CELLML_EQUATIONS
    TYPE(SOLVERS_TYPE), POINTER :: SOLVERS
    ...
    CALL ENTERS("FINITE_ELASTICITY_CONTACT_PROBLEM_SETUP",ERR,ERROR,*999)

    NULLIFY(CONTROL_LOOP)
    NULLIFY(NONLINEAR_SOLVER)
    NULLIFY(TRANSFORMATION_SOLVER)
    NULLIFY(PROJECTION_SOLVER)
    NULLIFY(CELLML_SOLVER)
    NULLIFY(SOLVER_EQUATIONS)
    NULLIFY(SOLVERS)
    NULLIFY(CELLML_EQUATIONS)
      ...
      CASE(PROBLEM_SETUP_SOLVERS_TYPE)
        ...
        CASE(PROBLEM_SETUP_START_ACTION)
          ...
          CASE(PROBLEM_FE_CONTACT_TRANSFORM_SUBTYPE)
            ...
            CALL SOLVERS_SOLVER_GET(SOLVERS,1,TRANSFORMATION_SOLVER,ERR,ERROR,*999)
            CALL SOLVER_TYPE_SET(TRANSFORMATION_SOLVER,SOLVER_GEOMETRIC_TRANSFORMATION_TYPE,ERR,ERROR,*999)
            !Set the second solver to be a nonlinear solver
            CALL SOLVERS_SOLVER_GET(SOLVERS,2,NONLINEAR_SOLVER,ERR,ERROR,*999)
            CALL SOLVER_TYPE_SET(NONLINEAR_SOLVER,SOLVER_NONLINEAR_TYPE,ERR,ERROR,*999)
        ...
        CASE(PROBLEM_SETUP_FINISH_ACTION)
          ...
          CASE(PROBLEM_FE_CONTACT_TRANSFORM_SUBTYPE)
            CALL SOLVERS_SOLVER_GET(SOLVERS,1,TRANSFORMATION_SOLVER,ERR,ERROR,*999)
            CALL SOLVER_CREATE_FINISH(TRANSFORMATION_SOLVER,ERR,ERROR,*999)
          CASE(PROBLEM_FE_CONTACT_REPROJECT_SUBTYPE)
            CALL FLAG_ERROR("Not implemented yet.",ERR,ERROR,*999)
          CASE DEFAULT
            LOCAL_ERROR="Problem subtype "//TRIM(NUMBER_TO_VSTRING(PROBLEM%SUBTYPE,"*",ERR,ERROR))// &
      ...
      CASE(PROBLEM_SETUP_SOLVER_EQUATIONS_TYPE)
        ...
        CASE(PROBLEM_SETUP_START_ACTION)
          ...
          CASE(PROBLEM_FE_CONTACT_TRANSFORM_REPROJECT_SUBTYPE)
            CALL FLAG_ERROR("Not implemented yet.",ERR,ERROR,*999)
          CASE(PROBLEM_FE_CONTACT_TRANSFORM_SUBTYPE)
            !Nonlinear solver is the second solver after the transformation solver
            CALL SOLVERS_SOLVER_GET(SOLVERS,2,NONLINEAR_SOLVER,ERR,ERROR,*999)
          CASE(PROBLEM_FE_CONTACT_REPROJECT_SUBTYPE)
            CALL FLAG_ERROR("Not implemented yet.",ERR,ERROR,*999)
          CASE DEFAULT
          ...
          END SELECT
          !Create the solver equatgions
          CALL SOLVER_EQUATIONS_CREATE_START(NONLINEAR_SOLVER,SOLVER_EQUATIONS,ERR,ERROR,*999)
          CALL SOLVER_EQUATIONS_LINEARITY_TYPE_SET(SOLVER_EQUATIONS,SOLVER_EQUATIONS_NONLINEAR,ERR,ERROR,*999)
          CALL SOLVER_EQUATIONS_TIME_DEPENDENCE_TYPE_SET(SOLVER_EQUATIONS,SOLVER_EQUATIONS_STATIC,ERR,ERROR,*999)
          CALL SOLVER_EQUATIONS_SPARSITY_TYPE_SET(SOLVER_EQUATIONS,SOLVER_SPARSE_MATRICES,ERR,ERROR,*999)
        CASE(PROBLEM_SETUP_FINISH_ACTION)
    ...
    CALL EXITS("FINITE_ELASTICITY_CONTACT_PROBLEM_SETUP")
    RETURN
999 CALL ERRORS("FINITE_ELASTICITY_CONTACT_PROBLEM_SETUP",ERR,ERROR)
    CALL EXITS("FINITE_ELASTICITY_CONTACT_PROBLEM_SETUP")
    RETURN 1
  END SUBROUTINE FINITE_ELASTICITY_CONTACT_PROBLEM_SETUP
...
999 CALL ERRORS("FINITE_ELASTICITY_PROBLEM_SUBTYPE_SET",ERR,ERROR)
  ...
  !>Sets/changes the problem subtype for a finite elasticity type .
  SUBROUTINE FINITE_ELASTICITY_CONTACT_PROBLEM_SUBTYPE_SET(PROBLEM,PROBLEM_SUBTYPE,ERR,ERROR,*)
    ...
    CALL ENTERS("FINITE_ELASTICITY_CONTACT_PROBLEM_SUBTYPE_SET",ERR,ERROR,*999)
    ...
    CALL EXITS("FINITE_ELASTICITY_CONTACT_PROBLEM_SUBTYPE_SET")
    RETURN
999 CALL ERRORS("FINITE_ELASTICITY_CONTACT_PROBLEM_SUBTYPE_SET",ERR,ERROR)
    CALL EXITS("FINITE_ELASTICITY_CONTACT_PROBLEM_SUBTYPE_SET")
    RETURN 1
  END SUBROUTINE FINITE_ELASTICITY_CONTACT_PROBLEM_SUBTYPE_SET
