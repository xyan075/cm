...
MODULE DATA_POINT_ROUTINES
  ...
  PUBLIC DATA_POINTS_VALUES_GET,DATA_POINTS_VALUES_SET,DATA_POINTS_VALUES_FIELD_EVALUATE
...
999 CALL ERRORS("DATA_POINTS_LABEL_SET_VS",ERR,ERROR)    
  ...
  SUBROUTINE DATA_POINTS_VALUES_FIELD_EVALUATE(DATA_POINTS,DATA_PROJECTION,FIELD,ERR,ERROR,*)
    ...
    CALL ENTERS("DATA_POINTS_VALUES_FIELD_EVALUATE",ERR,ERROR,*999)
    ...
    CALL EXITS("DATA_POINTS_VALUES_FIELD_EVALUATE")
    RETURN
999 CALL ERRORS("DATA_POINTS_VALUES_FIELD_EVALUATE",ERR,ERROR)    
    CALL EXITS("DATA_POINTS_VALUES_FIELD_EVALUATE")
    RETURN 1

  END SUBROUTINE DATA_POINTS_VALUES_FIELD_EVALUATE      
  !
  !================================================================================================================================
  !
