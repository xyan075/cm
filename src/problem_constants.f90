...
MODULE PROBLEM_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_FE_CONTACT_TRANSFORM_REPROJECT_SUBTYPE=1
  INTEGER(INTG), PARAMETER :: PROBLEM_FE_CONTACT_TRANSFORM_SUBTYPE=2
  INTEGER(INTG), PARAMETER :: PROBLEM_FE_CONTACT_REPROJECT_SUBTYPE=3
